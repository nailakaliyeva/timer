...
export default function Counter(props) {
	return (
		<div className="secondsParent row d-flex justify-content-center mx-5 bg-warning mt-5">
			<i className="far fa-clock fa-4x m-3 mr-5" />
			<div className="second col-2 bg-dark rounded m-1 my-3">
